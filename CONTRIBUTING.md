Contributing to mnsc Coin
============================

The mnsc Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mnsavings/mnsavings/blob/master/doc/translation_process.md)
...
The following applies to code changes to the mnsc Coin project, and is not to be
confused with overall MNSAVINGS Network Protocol consensus changes.

Whether a pull request is merged into mnsc Coin rests with the project merge
...
Patches that change MNSAVINGS consensus rules are considerably more involved than
...
Where a patchset proposes to change the MNSAVINGS consensus, it must have been
...
The project leader is the release manager for each mnsc Coin release.
