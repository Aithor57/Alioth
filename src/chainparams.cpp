...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x00000b031579955c1836fcbd6e8366454b803be8b442fa8d7750d3a5711abba7"))
	

	;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1656174637, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5727;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MNSAVINGS starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nmnsavingsBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nmnsavingsBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1656174637; //!> Sporks signed after , 02 02 2021 12:00:00 GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "mnsavings mn saved";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1656174637;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 9279550;

        hashGenesisBlock = genesis.GetHash();

		assert(hashGenesisBlock == uint256("0x00000b031579955c1836fcbd6e8366454b803be8b442fa8d7750d3a5711abba7"));
        assert(genesis.hashMerkleRoot == uint256("0x9a5023309515da6da3ddb1f8cf358f1e4cee31b3809cb741c4c1a89c2d8220f3"));

        vSeeds.push_back(CDNSSeedData("138.68.173.91", "138.68.173.91"));
        vSeeds.push_back(CDNSSeedData("164.92.117.234", "164.92.117.234"));		
        vSeeds.push_back(CDNSSeedData("128.199.127.237", "128.199.127.237"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zmnsc to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nmnsavingsBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nmnsavingsBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet mnsavings addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet mnsavings script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mnsavings BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mnsavings BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mnsavings BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "mnscfGRkekRyDRNeJiLtYVEbvhXrNbmox";
